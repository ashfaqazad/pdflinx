...
//       console.error("Download failed response:", errText);
//       cancelProgress();
//       flow.handleError("Download failed from server");
//       return;
//     }
...
//     ) {
//       const errText = await fileRes.text();
//       console.error("Downloaded file is not PDF:", errText);
//       cancelProgress();
//       flow.handleError("Server did not return a valid PDF file");
//       return;
//     }
...
//       <p className="mt-1 text-xs text-gray-400">Less compression</p>
//     </button>
...
//       <p className="mt-1 text-xs text-gray-400">Balanced size & quality</p>
//     </button>
...
//       }`}
//     >
//       <p className="font-semibold">Max Compression</p>
//       <p className="mt-1 text-xs text-gray-400">Smallest file size</p>
//     </button>
//   </div>
// );
//   return (

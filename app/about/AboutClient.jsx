...
export default function About() {
  const jsonLd = {
    ...
    description:
      "PDF Linx was born from frustration with clunky PDF tools. 31+ free tools, no signups, no subscriptions. Built and maintained solo by one developer.",
    ...
    __html: `
      @import url('https://fonts.googleapis.com/css2?family=Instrument+Serif:ital@0;1&family=DM+Sans:opsz,wght@9..40,300;9..40,400;9..40,500;9..40,600&display=swap');
        ...
        .dev-avatar {
          ...
          background: linear-gradient(135deg, #FEF0ED, #FFE4DC);
          display: flex; align-items: center; justify-content: center;
          font-size: 1.8rem; flex-shrink: 0;
          border: 1px solid rgba(232,56,13,.15);
        }
        .dev-link-btn {
        ...
        .dev-link-btn:hover { transform: translateY(-2px); box-shadow: 0 8px 20px rgba(0,0,0,.18); }
...
/>
      ...
      <main className="about-page min-h-screen">
        ...
        <section className="about-hero">
          ...
          <div className="fade-in delay-1">
            ...
            <div className="about-pills" style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
              {["🚀 31+ tools", "🔒 Browser-first privacy", "🧑‍💻 Built & run solo"].map((p) => (
          ...
          <div className="fade-in delay-2">
            <div style={{
              ...
              <div style={{
                ...
                {[["31+", "Free Tools"], ["0", "Signups Needed"], ["24/7", "Available"]].map(([num, lbl]) => (
                  <div key={lbl} style={{
                    textAlign: "center",
                    borderRight: lbl !== "Available" ? "1px solid #E5E2DC" : "none",
                  }}>
          ...
          <div className="backstory-grid">
            ...
            <div className="story-card fade-in delay-2">
              ...
              <p style={{ fontSize: 14, color: "#3D3D3D", lineHeight: 1.8 }}>
                In November, I shared it on Reddit and it <strong>picked up real traction</strong> — students, freelancers, and fellow devs started using it. A friend merged her thesis PDFs in seconds, a café owner made QR codes for their menu.
              </p>
          ...
          <div className="global-inner">
            <div>
              ...
              <p style={{ fontSize: 14, color: "rgba(255,255,255,.6)", maxWidth: 520, lineHeight: 1.75, marginBottom: ".8rem" }}>
                What started as a solo weekend project is now used by students, freelancers, developers, and small business owners. No matter where you're working from — PDF Linx just works, no region locks, no restrictions.
              </p>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                {["🎓 Students & researchers", "💼 Freelancers", "🏢 Small businesses", "💻 Developers", "🌐 Works anywhere"].map(t => (
            ...
            <div className="global-stat">
              <span style={{ fontFamily: "'Instrument Serif', serif", fontSize: "2.2rem", color: "#fff", display: "block" }}>Always</span>
              <span style={{ fontSize: 12, color: "rgba(255,255,255,.5)" }}>Free & Open</span>
            </div>
          </div>
        </section>
            ...
            <div>
              ...
              <div className="timeline-wrap">
                {[
                  ...
                  { date: "Nov '23", title: "Reddit went wild", body: "A Reddit post picked up real traction. Added a QR generator after several requests.", badge: "🚀 Reddit launch" },
                  ...
                  { date: "Today", title: "Still going", body: "31 tools. 0 bloat. 100% indie energy. Same soul — one human helping others skip the BS.", badge: "31 tools · solo-run" },
                ].map((item) => (
        ...
        <section className="about-section" style={{ maxWidth: 1100, margin: "0 auto", padding: "4rem 2rem" }}>
          ...
          <h2 style={{ fontFamily: "'Instrument Serif', serif", fontSize: "clamp(1.8rem,3vw,2.6rem)", lineHeight: 1.2, color: "#111", marginBottom: ".5rem" }}>
            Just one developer, no team
          </h2>
          <p style={{ fontSize: 15, color: "#888", marginBottom: "2rem", maxWidth: 540 }}>
            The person building, fixing, and shipping every tool on this site.
          </p>

          <div className="dev-card fade-in delay-2">
            <div className="dev-avatar">👋</div>
            <div style={{ flex: 1, minWidth: 240 }}>
              <h3 style={{ fontFamily: "'Instrument Serif', serif", fontSize: "1.4rem", color: "#111", marginBottom: 2 }}>
                Ashfaque Ahmed
              </h3>
              <p style={{ fontSize: 13, color: "#E8380D", fontWeight: 600, marginBottom: ".8rem" }}>
                Full-stack Developer
              </p>
              <p style={{ fontSize: 14, color: "#3D3D3D", lineHeight: 1.8, marginBottom: "1.2rem" }}>
                I design, build, and maintain PDF Linx end to end — backend converters, the UI, the SEO, all of it.
                I also run{" "}
                
                <a href="https://convertlinx.com"
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{ color: "#E8380D", textDecoration: "none", borderBottom: "1px solid rgba(232,56,13,.3)" }}
                >
                  ConvertLinx
                </a>, a sister site for everyday file conversions. No agency, no outsourcing — just one person who enjoys building tools that don't waste your time.
              </p>
              
                <a href="https://ashfaqdev.cloud"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="cta-band">
          ...
          <p style={{ marginTop: "1rem", fontSize: 12, color: "rgba(255,255,255,.5)" }}>
            ⭐ Built independently · No tracking · Made with ❤ · No data retained
          </p>
        </div>

  ...
  return (
    <>
      ...
      <ToolPageLayout
        ...
        //   heroTitle: (
        //     <>
        //       Convert Word to PDF <br />
        //       in <span className="text-blue-600">Seconds ⚡</span>
        //     </>
        //   ),
        //   heroDescription:
        //     "Convert DOC and DOCX files to PDF instantly. Fast, free and formatting preserved — no signup required.",
        // }}
...
//   // ── API LOGIC (WordToPdf ka apna logic) ─────────────
//   const handleConvert = async () => {
//     if (!flow.files.length) return alert("Please select a Word file first!");
...
//         const a = document.createElement("a");
//         a.href = url;
//         a.download = flow.files[0].name.replace(/\.(doc|docx)$/i, ".pdf");
//         document.body.appendChild(a);
//         a.click();
//         a.remove();
...
//             url: "https://pdflinx.com/word-to-pdf",
//             step: [
//               { "@type": "HowToStep", name: "Upload Word File(s)", text: "Upload one Word file or select multiple DOC/DOCX files." },
//               { "@type": "HowToStep", name: "Click Convert", text: "Press Convert to PDF and wait a few seconds." },
//               { "@type": "HowToStep", name: "Download PDF or ZIP", text: "Single file downloads as PDF. Multiple files download as a ZIP." },
//             ],
//             totalTime: "PT30S",
...
//             "@type": "FAQPage",
//             mainEntity: [
//               { "@type": "Question", name: "Is the Word to PDF converter free?", acceptedAnswer: { "@type": "Answer", text: "Yes, completely free with no hidden charges." } },
//               { "@type": "Question", name: "Do I need to install any software?", acceptedAnswer: { "@type": "Answer", text: "No. Everything works directly in your browser." } },
//               { "@type": "Question", name: "Will my Word formatting be preserved?", acceptedAnswer: { "@type": "Answer", text: "Yes, fonts, tables, images, and layout are preserved accurately." } },
//               { "@type": "Question", name: "Can I convert multiple Word files at once?", acceptedAnswer: { "@type": "Answer", text: "Yes. Upload up to 10 files — all PDFs delivered as a ZIP download." } },
//             ],
//           }, null, 2),
//         }}
//       />
...
//       {/* ── TOOL UI ── */}
//       <ToolPageLayout
//         title={seo?.h1 || "Convert Word to PDF Online Free"}
//         tagline="No Signup · No Watermark · Instant Download"
...
//         sidebarIcon={<FileText className="h-5 w-5 text-blue-500" />}
//         sidebarTitle="Word to PDF"
//         sidebarDescription="Convert DOC and DOCX files to PDF instantly — fonts, tables, and layout stay perfect."
//         sidebarNotice={SIDEBAR_NOTICE}
//         sidebarFeatures={SIDEBAR_FEATURES}
//         optionsSlot={null}
//       />

//       {/* ── SEO CONTENT — baad mein add karna ── */}
//       <RelatedToolsSection currentPage="word-to-pdf" />
//     </>
//   );
// }

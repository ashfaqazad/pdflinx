      ...
      <ToolPageLayout
              ...
              <div className="border-t border-slate-200 p-4">
                <button
                  ...
                  className={`flex w-full items-center justify-center gap-2 rounded-xl px-5 py-4 text-base font-bold text-white transition active:scale-[0.98] ${
                    selectedPages.length && !flow.isProcessing
        ...
        uploadLanding={{
          content: {
            ...
            noticeItems: ["Single PDF → Updated PDF directly", "Preview pages before removing", "No signup, no watermark"],
            breadcrumbItems: [
              { label: "Home", href: "/" },
            ...
            supports: ["Supports PDF files", "Auto-deleted after 1 hour"],
            howToTitle: "How to Remove Pages from PDF",
            howToSteps: [
              { n: "1", title: "Upload Your PDF", desc: "Choose a PDF from your device. Drag and drop supported on all devices.", color: "bg-blue-600" },
              { n: "2", title: "Select Pages to Remove", desc: "Click page thumbnails to mark the pages you want to delete. Select multiple at once.", color: "bg-purple-600" },
              { n: "3", title: "Remove & Download", desc: "Remove selected pages and download your clean updated PDF instantly. No watermark.", color: "bg-emerald-600" },
            ],
            ...
            whyItems: [
              { title: "Visual Page Preview", desc: "See all PDF pages as thumbnails before removing — click to select, click again to deselect. Full control.", icon: Image, iconColor: "text-blue-500", bgColor: "bg-blue-50" },
              { title: "Remove Multiple Pages at Once", desc: "Select and delete as many pages as you need in one go — no need to process the PDF multiple times.", icon: Image, iconColor: "text-red-500", bgColor: "bg-red-50" },
              { title: "Original Quality Preserved", desc: "Only selected pages are removed. All remaining pages keep their original formatting, fonts, and images.", icon: Image, iconColor: "text-emerald-500", bgColor: "bg-emerald-50" },
              { title: "Works on Any Device", desc: "Remove PDF pages on iPhone, Android, Windows, or Mac — no software installation needed.", icon: Image, iconColor: "text-orange-500", bgColor: "bg-orange-50" },
            ],
            relatedTitle: "You Might Also Need",
            relatedTools: [
              { label: "Split PDF", href: "/split-pdf", desc: "Split PDF into separate files", icon: Scissors, iconColor: "text-pink-500", bgColor: "bg-pink-50" },
              { label: "Merge PDF", href: "/merge-pdf", desc: "Combine multiple PDFs", icon: FilePlus, iconColor: "text-violet-500", bgColor: "bg-violet-50" },
              { label: "Compress PDF", href: "/compress-pdf", desc: "Reduce PDF file size", icon: FileMinus, iconColor: "text-green-500", bgColor: "bg-green-50" },
              { label: "Rotate PDF", href: "/rotate-pdf", desc: "Rotate PDF pages", icon: RotateCw, iconColor: "text-amber-500", bgColor: "bg-amber-50" },
            ...
            faqs: [
              { q: "Is the PDF page remover free to use?", a: "Yes, completely free. No hidden charges, no subscription, no limits." },
              { q: "Do I need to install any software?", a: "No. Everything works directly in your browser. No desktop software or plugins needed." },
              { q: "Can I remove multiple pages at once?", a: "Yes. Select as many pages as you need and remove them all in one click." },
              { q: "Will the remaining pages keep their original quality?", a: "Yes. Only the selected pages are removed. All remaining pages keep their original formatting, fonts, images, and layout." },
              { q: "Can I preview pages before removing them?", a: "Yes. All PDF pages are shown as thumbnails. Click to select the ones you want to remove before confirming." },
              ...
              { q: "Can I remove pages on my phone?", a: "Yes. PDFLinx works on Android and iOS mobile devices, tablets, and all desktop browsers — no app required." },
              { q: "What if I want to keep only specific pages?", a: "Select all the pages you want to remove and download the updated PDF — only your selected pages will be deleted." },
              { q: "Can I undo the page removal?", a: "Once downloaded, the removal cannot be undone. We recommend keeping a backup of your original PDF before removing pages." },
              { q: "What is the difference between Remove Pages and Split PDF?", a: "Remove Pages deletes specific pages from your PDF and gives you one updated file. Split PDF divides your PDF into separate files by page range or individual pages." },
            ],
            ctaBadge: "✦ 100% Free",
            ...
            seoSections: [
              { title: "Free PDF Page Remover — Delete Any Page from Your PDF Instantly", text: "Need to remove unwanted pages from a PDF? PDFLinx lets you visually select and delete any page from your PDF document — no software, no signup, no watermark." },
              { title: "What is PDF Page Removal?", text: "PDF page removal is the process of deleting one or more specific pages from a PDF document while keeping all remaining pages intact." },
              { title: "Common Use Cases for Removing PDF Pages", text: "Remove blank or empty pages from scanned documents. Delete confidential pages before sharing a report. Remove cover pages or headers from downloaded PDFs." },
              { title: "Privacy and File Security", text: "PDFLinx takes your privacy seriously. Uploaded PDF files are processed securely and permanently deleted after conversion — never stored long-term, never shared with third parties." },
              { title: "Remove PDF Pages on Any Device", text: "Works on Windows, macOS, Linux, Android, and iOS — directly in your browser. No app download needed." },
            ],
            showPdfTypes: false,
          },
        }}

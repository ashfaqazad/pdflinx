      ...
      <ToolPageLayout
        ...
        uploadLanding={{
          content: {
            ...
            heroDescription:
              "Extract every PDF page as a lossless PNG image instantly — no signup, no watermark. Transparent background supported. Single-page PDF downloads as PNG. Multi-page PDF downloads as ZIP. Works on Windows, Mac, Android, and iOS.",

            bullets: [
              "Every PDF page extracted as a separate lossless PNG image",
              "Transparent background fully supported",
            ...
            noticeTitle: "PDF to PNG Output",
            noticeItems: [
              "Single-page PDF → PNG directly",
              "Multi-page PDF → ZIP with all PNGs",
            ...
            howToSteps: [
              ...
              },
              {
                ...
                desc: "PDFLinx renders every page of your PDF as a lossless PNG image — text razor-sharp, colors pixel-perfect, transparent backgrounds preserved.",
                color: "bg-indigo-600",
              },
              {
                n: "3",
                title: "Download PNG or ZIP",
                desc: "Single-page PDF downloads as one PNG directly. Multi-page PDF downloads as a ZIP with one PNG per page.",
                color: "bg-purple-600",
              },
            ],

            visualImage: "/images/pdf-to-png-visual.png",
            visualAlt: "PDF to PNG conversion illustration",

            whyTitle: "Why Choose PDFLinx PDF to PNG?",

            whyItems: [
              {
                title: "Lossless PNG Quality",
                desc: "Every PDF page extracted at full lossless quality — text stays pixel-sharp, colors are accurate, and transparent backgrounds are fully preserved.",
                icon: ImageIcon,
              ...
              },
              {
                ...
                desc: "Single-page PDF downloads as one PNG directly. Multi-page PDF downloads as ZIP with all PNGs inside — no manual work.",
                icon: FileImage,
              ...
              },
              {
                ...
                desc: "Upload multiple PDFs at once — each processed separately and delivered as individual PNG or ZIP downloads.",
                icon: FilePlus,
              ...
              },
              {
                ...
                desc: "Convert PDF to PNG on iPhone, Android, Windows, or Mac — no software installation needed. Fully browser-based.",
                icon: Minimize2,
            ...
            relatedTools: [
              { label: "PDF to JPG",    href: "/pdf-to-jpg",    desc: "Convert PDF pages to JPG",          icon: FileImage,  iconColor: "text-amber-500",   bgColor: "bg-amber-50"   },
              { label: "Image to PDF",  href: "/image-to-pdf",  desc: "Convert PNG images back to PDF",    icon: ImageIcon,  iconColor: "text-orange-500",  bgColor: "bg-orange-50"  },
            ...
            faqs: [
              { q: "Is the PDF to PNG converter free?", a: "Yes. PDFLinx PDF to PNG is completely free — no hidden charges, no subscription required." },
              { q: "Do I need to install any software?", a: "No. Everything works directly in your browser. No desktop software, no plugins needed." },
              { q: "What quality are the converted PNG images?", a: "PNG images are exported at full lossless quality — text stays pixel-sharp, colors are accurate, and transparent backgrounds are preserved." },
              { q: "How does the download work for single vs multi-page PDFs?", a: "Single-page PDFs download as one PNG file directly. Multi-page PDFs download as a ZIP file containing one PNG per page, named sequentially." },
              { q: "Can I convert multiple PDF files at once?", a: "Yes. Upload multiple PDFs simultaneously — each is processed separately and delivered as individual PNG or ZIP downloads." },
              ...
              { q: "What is the difference between PNG and JPG for PDF conversion?", a: "PNG is lossless — better for text, logos, diagrams, and transparent backgrounds. JPG produces smaller files — better for photos and social media." },
              { q: "What if I only need one page from a multi-page PDF?", a: "Use the Split PDF tool first to extract the specific page, then convert that single-page PDF to PNG for a direct download without a ZIP." },
            ],

            ctaBadge: "✦ 100% Free",
            ctaTitle: "Start Converting PDF Pages to PNG Now",
            ...
            seoSections: [
              {
                title: "Free PDF to PNG Converter — Extract Every Page as a Lossless Image",
                text: "Need PDF pages as lossless PNG images for design work, web graphics, or presentations? PDFLinx extracts every page from your PDF as a high-quality lossless PNG image — text razor-sharp, colors pixel-perfect, transparent backgrounds supported. No software installation, no watermarks, no sign-up required.",
              },
              {
                title: "How PDF to PNG Download Works",
                text: "PDFLinx automatically detects the number of pages in your PDF. A single-page PDF downloads as one PNG directly. A multi-page PDF downloads as a ZIP containing one PNG per page. Multiple PDFs are processed separately and delivered individually.",
              },
              {
                title: "Common Use Cases for PDF to PNG Conversion",
                text: "Design and web graphics — extract PDF diagrams and logos as PNG for use in Figma, Canva, or web pages. Presentations — insert PDF pages as lossless PNG into PowerPoint or Google Slides. Developer assets — extract UI mockups and wireframes from PDF as PNG for development workflows.",
              },
              {

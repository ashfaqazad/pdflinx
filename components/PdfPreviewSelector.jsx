...
export default function PdfPreviewSelector({
  file,
  selectedPages,
  setSelectedPages,
  hideHeader = false,        // ← naya prop — RemovePages mein true pass karo
  onTotalPages,              // ← callback — parent ko total pages batao
}) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* ── Header bar — hideHeader=true hoga to nahi dikhega ── */}
      {!hideHeader && file && (

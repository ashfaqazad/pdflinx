    ...
    return (
        <>
            ...
            >
                ...
                <div
                    className={`${desktopSidebarWidth} shrink-0 flex flex-col`}
                    style={{ height: "calc(100vh - 72px)" }}
                >
                    <div className="rounded-xl border border-gray-200 bg-white shadow-sm p-4 flex flex-col h-full overflow-y-auto">
                        {drawerContent}
                    </div>
                </div>
            </div>
                ...
                <AnimatePresence>
                    {drawerOpen && (
                        <motion.div
                            ...
                            className="fixed inset-y-0 right-0 z-50 rounded-l-2xl bg-white shadow-2xl w-[280px] flex flex-col"
                        >
                            {/* Handle */}

...
//           >
//             <p style={{
//               fontSize: 12, fontWeight: 1000, letterSpacing: "0.09em",
//               textTransform: "uppercase", color: "#7a7772",
//               margin: "6px 0 10px", whiteSpace: "nowrap"
//             }}>
//               {col.heading}
...
//           height: "100%", display: "flex", alignItems: "center",
//           justifyContent: "space-between", gap: 16, overflowX: "hidden",

//         }}>

//           {/* LOGO - Same style on both desktop & mobile */}
//           <Link href="/" style={{ display: "flex", alignItems: "center", gap: 8, textDecoration: "none", flexShrink: 0 }}>
//             <Image src="/pdflinx_logo.svg" alt="PDFLinx" width={30} height={30} priority />
//             <span style={{
//               fontFamily: "'Instrument Serif', Georgia, serif",
...
//                 >
//                   PDF Tools
//                   <ChevronDown size={13} style={{ transition: "transform .2s", transform: dropdownOpen ? "rotate(180deg)" : "none" }} />
//                 </button>
//                 <MegaDropdown open={dropdownOpen} onClose={closeDropdown} />
//               </div>
...
//             {/* Hamburger Button - Perfect Center */}
//             {!isDesktop && (
//               <button
//                 onClick={() => setMobileOpen(p => !p)}
//                 aria-label="Toggle menu"
...
//       {!isDesktop && mobileOpen && (
//         <>
//           <div onClick={closeAll} style={{ position: "fixed", inset: 0, background: "rgba(15,14,13,0.38)", zIndex: 110 }} />

//           <div style={{
//             position: "fixed", top: 0, right: 0, bottom: 0, width: "88vw",
//             background: "#ffffff", zIndex: 120, overflowY: "auto", boxShadow: "-16px 0 48px rgba(0,0,0,0.12)",
//             animation: "drawerSlide .25s ease", display: "flex", flexDirection: "column"
//           }}>
//             {/* Mobile Header - Same Brand Style */}
//             <div style={{
//               maxWidth: 1180,
//               margin: "0 auto",
//               padding: isDesktop ? "0 1.5rem" : "0 1rem",
...
//               {/* <div style={{
//               display: "flex", alignItems: "center", justifyContent: "space-between",
//               padding: "1rem 1.25rem", borderBottom: "1px solid rgba(15,14,13,0.08)",
//               position: "sticky", top: 0, background: "#fff", zIndex: 2
//             }}> */}
//               <Link href="/" onClick={closeAll} style={{ display: "flex", alignItems: "center", gap: 8, textDecoration: "none" }}>
//                 <Image src="/pdflinx_logo.svg" alt="PDFLinx" width={28} height={28} />
...
//                 </span>
//               </Link>
//               <button onClick={closeAll}><X size={22} /></button>
//             </div>
...
//                   borderBottom: "1px solid rgba(15,14,13,0.07)", fontSize: 15.5, fontWeight: 500,
//                   color: "#3a3835", textDecoration: "none"
//                 }}>
//                   {label}
//                 </Link>
...
//               {/* PDF Tools */}
//               <div style={{ borderBottom: "1px solid rgba(15,14,13,0.07)" }}>
//                 <button onClick={() => setMobileToolsOpen(p => !p)} style={{
//                   width: "100%", padding: "13px 0", display: "flex",
//                   justifyContent: "space-between", alignItems: "center",
//                   background: "none", border: "none", fontSize: 15.5, fontWeight: 500
//                 }}>
//                   PDF Tools
//                   <ChevronDown style={{ transform: mobileToolsOpen ? "rotate(180deg)" : "none" }} />
//                 </button>

//                 {mobileToolsOpen && (
//                   <div style={{ paddingBottom: 20 }}>
//                     <Link href="/free-pdf-tools" onClick={closeAll} style={{
//                       display: "flex", justifyContent: "center", gap: 6, padding: "10px 14px",
//                       marginBottom: 16, background: "#fff1ec", border: "1px solid rgba(232,66,10,0.2)",
//                       borderRadius: 10, color: "#e8420a", fontWeight: 500
//                     }}>
//                       🗂️ View All Free PDF Tools
//                     </Link>
...
//                       {dropdownCols.map(col => (
//                         <div key={col.heading}>
//                           <p style={{ fontSize: 10.5, fontWeight: 700, textTransform: "uppercase", color: "#7a7772", marginBottom: 8 }}>
//                             {col.heading}
//                           </p>
//                           {col.items.map(({ label, href, Icon, color }) => (
//                             <Link key={href} href={href} onClick={closeAll} style={{
//                               display: "flex", alignItems: "center", gap: 7, padding: "6px 0",
//                               fontSize: 13, color: "#3a3835", textDecoration: "none"
//                             }}>

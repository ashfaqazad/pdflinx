...
export const relatedToolsData = {
  ...
  'edit-pdf': [
    ...
    { title: 'Rotate PDF', emoji: '🔄', url: '/rotate-pdf', desc: 'Fix page orientation before editing' },
    { title: 'Protect PDF', emoji: '🔐', url: '/protect-pdf', desc: 'Secure your edited PDF with a password' },
  ],
  'ocr-pdf': [
    { title: 'Edit PDF', emoji: '✏️', url: '/edit-pdf', desc: 'Modify text, images, and pages in your PDF' },
    { title: 'Rotate PDF', emoji: '🔄', url: '/rotate-pdf', desc: 'Fix page orientation before processing' },
    { title: 'Protect PDF', emoji: '🔐', url: '/protect-pdf', desc: 'Secure your PDF with a password' },
  ],

  // Add Watermark — missing tha, ab add kiya
  'add-watermark': [
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 md:p-8">
        ...
        <div className="space-y-4">
          {tools.map((tool, index) => (
            // ✅ <a> ki jagah <Link> use kar rahe hain — SEO + fast navigation
            <Link
              key={index}
              href={tool.url}
